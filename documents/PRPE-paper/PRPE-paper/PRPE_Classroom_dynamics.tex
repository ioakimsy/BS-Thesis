...
\section{Mathematical models}
    ...
    Existing models are either predictive such as with the case of the neural network models~\cite{roxas2010seating} or lack the spatial aspect of the process as with the differential equations~\cite{pritchard2008mathematical,nitta2019mathematical}.
    In between these models is a more dynamical model using the Ising model~\cite{bordogna2001theoretical,bordogna2003simulation}.
    It lacks some aspects of PI that we would like to consider like seating arrangements, students' learning rate, and aptitude heterogeneity.

    Mathematical models for learning via PI mode, we have not found a model to compares PI and TI.
...
%%
    ...
    \end{equation}
    This normalized differential improvement tend to be biased towards low-scoring classes.
