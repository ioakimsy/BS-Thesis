...
\section{A probabilistic CA model}
    ...
    Here, we use a probabilistic cellular automata (pCA) model~\cite{SelfSPP} (also known as stochastic cellular automata) to study the spatiotemporal dynamics of learning that provides a more direct implementation of any instructional mode.
    ...
    Each student at each lattice position $(i,j)$ in this CA model is then assigned a learning rate
    ...
    For each time step, $t{\leftarrow}t+1$ and each student's state $s_{i,j}$ is updated depending on the mode of instruction described in the following.
    ...
    \begin{figure}[htb]
        ...
        \caption{%%
            ...
            The PI and TI differ on how the probability $P_{i,j}$ is computed as described in the text.
...
\section{Results and Discussion}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[$t=2$]{\includegraphics[width=0.23\textwidth]{figures/2D-BPCAIH-analysis/class evolutions/trad low rho high delta/2DBPCAIH-traditional-32-0.3-0.5-0.4-trial_1-2.png}}
        \subfigure[$t=8$]{\includegraphics[width=0.23\textwidth]{figures/2D-BPCAIH-analysis/class evolutions/trad low rho high delta/2DBPCAIH-traditional-32-0.3-0.5-0.4-trial_1-8.png}}
        \subfigure[$t=32$]{\includegraphics[width=0.23\textwidth]{figures/2D-BPCAIH-analysis/class evolutions/trad low rho high delta/2DBPCAIH-traditional-32-0.3-0.5-0.4-trial_1-32.png}}
        \subfigure[$t=161$]{\includegraphics[width=0.23\textwidth]{figures/2D-BPCAIH-analysis/class evolutions/trad low rho high delta/2DBPCAIH-traditional-32-0.3-0.5-0.4-trial_1-161.png}}
        \caption{Example classroom evolution for TI with $L=32$, $\rho_0=0.3$, and $\delta\lambda=0.4$ at different time steps $t$ showing a two-stage learning process.
