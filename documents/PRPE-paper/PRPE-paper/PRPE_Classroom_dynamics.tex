...
\section{A probabilistic CA model}
    ...
    The values of the model input parameters we considered for the class size $N=L^2$, the positional learning coefficient $\rho_0$, and the learning rate heterogeneity $\delta\lambda$ are as follows:
        ...
        For both TI and PI, the simulation is considered to have reached a steady state when no new students learn for $20$ consecutive time steps or when all students have learned.
...
\section{Results and Discussion}
    ...
    \subsection{Different Dynamics of Traditional and Peer Instruction}
        ...
        An example case where this phenomenon is observable is shown in Figure~\ref{fig:TI_evolution}.
    ...
    \begin{figure*}[htbp!]
        \centering
        \subfigure[Traditional Instruction (TI)]{\includegraphics[width=0.95\textwidth]{figures/2D-BPCAIH-analysis/class evolutions/TI class evolution.png}\label{fig:TI_evolution}}
        \subfigure[Peer Instruction (PI)]{\includegraphics[width=0.95\textwidth]{figures/2D-BPCAIH-analysis/class evolutions/PI class evolution.png}\label{fig:PI_evolution}}
