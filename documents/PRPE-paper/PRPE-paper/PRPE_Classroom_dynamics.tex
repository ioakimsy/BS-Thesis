...
\section{Results and Discussion}
    ...
    \subsection{Dynamical Difference between TI and PI}
        ...
        The effect of increasing size of the class $N$ for PI is to delay the time it takes for the class to speed up learning as opposed to the TI mode unaffectd by $N$.
        This is expected since for TI each student independently and simultaneously learns from the teacher directly.
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[width=0.45\textwidth]{figures/2D-BPCAIH-analysis/comparison plots/SA.png}
        \caption{Comparison of time to learn $t_{\rm max}$ and fraction of learned students for different seating arrangements (SAs).
