...
\section{Comparison with available data}
    ...
    \end{figure}
    %%
    Figure~\ref{fig:Return map} shows the $h(f)$ that fits our simulation data for PI of smaller class sizes (Subfigure b) approaching the expectations of the model of Nitta.
