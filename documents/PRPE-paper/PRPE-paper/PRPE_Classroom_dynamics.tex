...
\section{Results and Discussion}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Traditional Instruction (TI)]{\includegraphics[width=0.46\textwidth]{figures/2D-BPCAIH-analysis/class evolutions/TI class evolution.png}}
        \subfigure[Peer Instruction (PI)]{\includegraphics[width=0.46\textwidth]{figures/2D-BPCAIH-analysis/class evolutions/PI class evolution.png}}
