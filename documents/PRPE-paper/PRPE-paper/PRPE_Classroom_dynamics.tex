...
\section{Comparison with available data}
    ...
    \textcolor{red}{
    Furthermore, our simulation results exhibit close agreement with the empirical data reported by Roxas~\cite{roxas2010seating}, as illustrated in Figure~\ref{fig:Return map}.
    Roxas' dataset, consisting of pre- and post-test scores from fourteen PI classrooms, spans a broad range of values, within which both Nitta's model and our simulation results are contained.
    For the representative cases examined, our PI model produces return maps that lie between those generated by Nitta's model and the Roxas dataset.
    }
    ...
    Thus, our model provides an intermediate behavior between Roxas' empirical data and Nitta's predictions.
    ...
    Moreover, the comparison was carried out qualitatively by examining the best-fit lines of the return maps.  
