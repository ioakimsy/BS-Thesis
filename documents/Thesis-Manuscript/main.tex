...
%% Header section
\title{Learning dynamics in a cellular automata model of classroom peer-to-peer interactions} %%required
...
\gradyear{2024} \gradmonth{June} %%graduation month and year
...
\input{2BPCA.tex}
\input{3BPCAmodifications.tex} %%could be model or experiment set-up
